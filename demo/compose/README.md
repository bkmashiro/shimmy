...
- Shimmy Python NumPy-core bundle: generated by the manual Artifact CI from this repository and verified with its commit-bound manifest and `SHA256SUMS`; no runtime Wasm is tracked in Git LFS.
